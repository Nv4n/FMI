...
BigNumber &BigNumber::operator+(BigNumber &sndCollectable) {
    ...
    for (size_t smallerCollectableIndex = 0;
         smallerCollectableIndex < largerCollectableLength; smallerCollectableIndex++) {
    ...
    for (size_t largerCollectableIndex = largerCollectableLength;
         largerCollectableIndex < smallerCollectableLength; largerCollectableIndex++) {
