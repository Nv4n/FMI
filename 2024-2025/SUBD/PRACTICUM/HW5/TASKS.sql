...
-- Предварително създадена процедура
...
-- Нова Процедура
CREATE OR REPLACE PROCEDURE PROC_DEPT_EMPLOYEES_JOB_HISTORY(IN DEPT_ID INT)
BEGIN
    DECLARE EMP_ID INT DEFAULT NULL;
    ...
    WHILE SQLSTATE = '00000'
        DO
            ...
            THEN
                CALL FN24_3MI0700035.GET_EMP_INFO(EMP_ID);
...
BEGIN
    CALL FN24_3MI0700035.GET_EMP_INFO(100);
end;

BEGIN
    CALL FN24_3MI0700035.PROC_DEPT_EMPLOYEES_JOB_HISTORY(90);
end;